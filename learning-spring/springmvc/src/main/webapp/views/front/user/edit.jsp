            ...
            <div class="container">
                ...
                <form class="row g-3" action="/user/${user.id}/update" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" id="dob" name="dob" placeholder="Enter date of birth" class="form-control" value="${user.dob}" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <select id="selectedSkills" name="selectedSkills" class="form-select" multiple aria-label="multiple select">
                            <c:forEach items="${skills}" var="skill">
                                <option value="${skill.id}" <c:if test="${not empty user.skills and user.skills.contains(skill)}">selected</c:if>>${skill.name}</option>
                            </c:forEach>
                        </select>
                    </div>
